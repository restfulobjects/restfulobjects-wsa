...
namespace RestfulObjects.Applib.IntegTest.Bomi2
{
    ...
    public class ActionInvokeGetTest_CustomerServiceFindByPpsn
    {
        ...
        public void Get()
        {
            ...
            link.Href.Should().Be("http://192.168.57.1:8888/services/sdm.restserver.RestRepositories.CustomerRepository/actions/FindByPPSN");
            ...
            link.Should().NotBeNull();
            link.Href.Should().Be("http://192.168.57.1:8888/services/sdm.restserver.RestRepositories.CustomerRepository/actions/FindByPPSN/invoke");
            ...
            link.Should().NotBeNull();
            link.Href.Should().Be("http://192.168.57.1:8888/domain-types/sdm.common.bom.customers.ICustomer");

            link = findByPpsnDetailsRepr.Links.Single(l => l.Rel == "describedby");
            link.Should().NotBeNull();
            link.Href.Should().Be("http://192.168.57.1:8888/domain-types/sdm.restserver.RestRepositories.CustomerRepository/actions/FindByPPSN");

            link = findByPpsnDetailsRepr.Links.Single(l => l.Rel.Contains("action-param") && l.Id == "PPSN");
            link.Should().NotBeNull();
            link.Href.Should().Be("http://192.168.57.1:8888/domain-types/sdm.restserver.RestRepositories.CustomerRepository/actions/FindByPPSN/params/PPSN");
        ...
        public void FollowSelf()
        {
            ...
            selfRepr.Links.Single(l => l.Rel == "self").Href.Should().Be("http://192.168.57.1:8888/services/sdm.restserver.RestRepositories.CustomerRepository/actions/FindByPPSN");
